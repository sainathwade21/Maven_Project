...
public class HomePage {
	...
	@FindAll({@FindBy(xpath = "(//td[@class='navItem relative'])[2]"), @FindBy(xpath = "//A[contains(@class,'content reports')]/descendant::img[@class='sizer']")})
	private WebElement tasksElement;
	@FindBy(xpath = "//a[@class='Reports']")
	private WebElement reportsElement;
	@FindAll({@FindBy(xpath = "(//td[@class='navItem relative'])[4]"), @FindBy(xpath = "//a[@class='content users']")})
	...
	// Elements present inside Web page
	...
	public WebElement getTasksElement() {
		return tasksElement;
	}
